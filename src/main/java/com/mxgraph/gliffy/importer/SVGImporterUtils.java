...
public class SVGImporterUtils {
    ...
    public String setViewBox(String svgString) {
        try {
            ...
            log.warn("Cannot set viewBox for: {} with error {}", svgString, exc.getLocalizedMessage());
        }
    ...
    private String getViewBoxString(Object svg) throws Exception {
        ...
        return String.format("viewBox=\"%s %s %s %s\"", getIntValue(x.toString()), getIntValue(y.toString()),
